...
public class ProductInActivateTest extends MockMvcTest {
	...
	void 상품_비활성화_성공__200_OK() throws Exception {
		...
		ProductEntity inActivatedProduct = productRepository.findById(product.getId()).orElseThrow();
		assertThat(inActivatedProduct.getStatus()).isEqualTo(ProductStatus.IN_ACTIVATED);
	}
}
